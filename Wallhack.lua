    ...
    AddESP = function(Player)
        ...
        PlayerTable.Connections.ESP = RunService.RenderStepped:Connect(function()
            pcall(function()
                ...
                if Player.Character and Player.Character.Parent and Player.Character:FindFirstChildOfClass("Humanoid") and Player.Character:FindFirstChildOfClass("Humanoid").Health > 0 and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Character:FindFirstChild("Head") and Environment.Settings.Enabled then
            ...
            pcall(function()
                ...
                if Player.Character and Player.Character.Parent and Player.Character:FindFirstChildOfClass("Humanoid") and Player.Character:FindFirstChildOfClass("Humanoid").Health > 0 and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Character:FindFirstChild("Head") and Environment.Settings.Enabled then
                    ...
                    if OnScreen and Environment.Visuals.BoxSettings.Enabled then
                        ...
                        if PlayerTable.Box.Square.Visible and not PlayerTable.Box.TopLeftLine.Visible then
    ...
    AddHeadDot = function(Player)
        ...
        PlayerTable.Connections.HeadDot = RunService.RenderStepped:Connect(function()
            pcall(function()
                ...
                if Player.Character and Player.Character.Parent and Player.Character:FindFirstChildOfClass("Humanoid") and Player.Character:FindFirstChildOfClass("Humanoid").Health > 0 and Player.Character:FindFirstChild("Head") and Environment.Settings.Enabled then
                    local Vector, OnScreen = WorldToViewportPoint(Player.Character.Head.Position)
    ...
    AddHealthBar = function(Player)
        ...
        PlayerTable.Connections.HealthBar = RunService.RenderStepped:Connect(function()
            pcall(function()
                ...
                if Player.Character and Player.Character.Parent and Player.Character:FindFirstChildOfClass("Humanoid") and Player.Character:FindFirstChildOfClass("Humanoid").Health > 0 and Player.Character:FindFirstChild("HumanoidRootPart") and Environment.Settings.Enabled then
                    local Vector, OnScreen = WorldToViewportPoint(Player.Character.HumanoidRootPart.Position)
...
local function Wrap(Player)
    if not GetPlayerTable(Player) then
        ...
        PlayerTable.Connections.CharacterAdded = Player.CharacterAdded:Connect(function()
            task.wait(1) -- Increased delay for character to fully load
            pcall(function()
                AssignRigType(Player)
