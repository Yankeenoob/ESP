    ...
    AddESP = function(Player)
        ...
        PlayerTable.Connections.ESP = RunService.RenderStepped:Connect(function()
            pcall(function()
                ...
                if Player.Character and Player.Character.Parent and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Character:FindFirstChild("Head") and Environment.Settings.Enabled then
                    ...
                    if Environment.Visuals.ESPSettings.Enabled and OnScreen then
                        ...
                        local Parts, Content, Tool = {
                            Health = Humanoid and "(" .. tostring(mathfloor(Humanoid.Health)) .. ")" or "",
                        ...
                        if Environment.Visuals.ESPSettings.DisplayHealth and Humanoid then
    ...
    AddHeadDot = function(Player)
        ...
        PlayerTable.Connections.HeadDot = RunService.RenderStepped:Connect(function()
            pcall(function()
                ...
                if Player.Character and Player.Character.Parent and Player.Character:FindFirstChild("Head") and Environment.Settings.Enabled then
                    local Vector, OnScreen = WorldToViewportPoint(Player.Character.Head.Position)
